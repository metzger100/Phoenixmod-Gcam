...
# For Devs
  ...
  After smali-projects are not easy to work with, I recommend to use Android Studio to code in Java compile it up to an apk. Then you decompile it with apktool and copy the smali code into the smali project. If you made some **new graphics** please upload the raw imagefiles (e.g. .svg; .png) [here](https://github.com/metzger100/Phoenixmod-Gcam-Data).
